...
import '@underverse/core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IUnderVerseSwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IUnderVersePool) {
        return IUnderVersePool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IUnderVerseSwapCallback
    function uniswapV3SwapCallback(
        ...
        IUnderVersePool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IUnderVersePool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
