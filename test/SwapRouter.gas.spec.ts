...
import { IUnderVersePool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
import { abi as IUnderVersePoolABI } from '@underverse/core/artifacts/contracts/interfaces/IUnderVersePool.sol/IUnderVersePool.json'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IUnderVersePool, IUnderVersePool, IUnderVersePool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IUnderVersePoolABI, wallet)) as [
      IUnderVersePool,
      IUnderVersePool,
      IUnderVersePool
    ]
  ...
  let pools: [IUnderVersePool, IUnderVersePool, IUnderVersePool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestUnderVerseCallee')
